...
open class SwipeCollectionViewCell: UICollectionViewCell {
    ...
    public func configure() {
        ...
        if containerView.translatesAutoresizingMaskIntoConstraints == true {
        ...
        swipeController = SwipeController(swipeable: self, actionsContainerView: containerView)
    ...
    //   if it's supposed to, since otherwise, our `containerView` will swallow it and pass it up to
    //   the collection view.
    /// :nodoc:
